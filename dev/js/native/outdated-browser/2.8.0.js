...
module.exports = function(options) {
	var main = function() {
		...
		var backgroundColor = options.backgroundColor || COLORS.white
		var textColor = options.textColor || COLORS.salmon
    ...
    var fade = options.fade || false
		...
		var getmessage = function(lang) {
			...
			var updateMessages = {
				web:
					"<li>" + messages.update.web + "</li>" +
					'<li><a id="buttonUpdateBrowser" rel="nofollow" href="' +
					messages.url +
					'">' +
					messages.callToAction +
					"</a></li>",
				googlePlay:
					"<li>" + messages.update.googlePlay + "</li>" +
					'<li><a id="buttonUpdateBrowser" rel="nofollow" href="https://play.google.com/store/apps/details?id=com.android.chrome">' +
					messages.callToAction +
					"</a></li>",
				appStore: "<li>" + messages.update[updateSource] + "</li>"
			}
        ...
        "</div>" +
        '<a class="close icon" href="#" id="buttonCloseUpdateBrowser">' +
		...
		if (isBrowserOutOfDate() || !isPropertySupported(requiredCssProperty) || isAndroidButNotChrome) {
			...
			if (done && outdatedUI.style.opacity !== "1" && fade) {
				done = false
